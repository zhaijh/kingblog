...
using King.Blog.Domain.Shared;
using Microsoft.EntityFrameworkCore;
using System;
using System.Collections.Generic;
using System.Text;
using Volo.Abp;
using static King.Blog.Domain.Shared.KingBlogDbConsts;

namespace King.Blog.EntityFrameworkCore
{
  public static  class KingBlogDbContextModelCreatingExtensions
    {
        public static void Configure(this ModelBuilder builder)
        {
            ...
            {
                b.ToTable(KingBlogConsts.DbTablePrefix + DbTableName.Posts);
                b.HasKey(x => x.Id);
            ...
            {
                b.ToTable(KingBlogConsts.DbTablePrefix + DbTableName.Categories);
                b.HasKey(x => x.Id);
            ...
            {
                b.ToTable(KingBlogConsts.DbTablePrefix + DbTableName.Tags);
                b.HasKey(x => x.Id);
            ...
            {
                b.ToTable(KingBlogConsts.DbTablePrefix + DbTableName.PostTags);
                b.HasKey(x => x.Id);
            ...
            {
                b.ToTable(KingBlogConsts.DbTablePrefix + DbTableName.Friendlinks);
                b.HasKey(x => x.Id);
